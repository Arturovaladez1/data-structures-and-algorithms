...
const addValues = (arr) => {
  // Solution code here...
  let addInt = arr.reduce((accum, val) => {
    return accum + val;
  }, 0);
  return addInt;
...
const addPurchases = (arr) => {
  ...
  return arr.reduce((accum, val) => {
    return accum = accum + val.purchasePrice;
  }, 0);
  // let purchaseTotals = arr.reduce((accum, val) => {
  //   return arr.purchasePrice + arr;
  // }, 0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((accum, val,idx) => {
...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((accum,val) => {
    return accum + val;
  }, 0);
  return newArr;
};
